    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent1">
      <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Other Animal</a>
        </div>
      </li>
      <li class="nav-item dropdown">
  ...
  <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xl-4">
          <form class="form-container needs-validation" action="other_done.php" enctype="multipart/form-data" method="post" novalidate>
            <h2>Information</h2>
    ...
    <div class="form-group">
      <label for="validationCustom06">Type of animal</label>
      <input type="text" class="form-control" name="type" id="validationCustom06" placeholder="type">
      <div class="invalid-feedback">
